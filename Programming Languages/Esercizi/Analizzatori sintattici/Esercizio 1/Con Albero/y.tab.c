...
#line 56 "Parser.y"
  ...
  case 6:
#line 59 "Parser.y"
    { (yyval)= createNode(' ',(yyvsp[(1) - (1)]),NULL,NULL);}
    break;

  case 7:
#line 60 "Parser.y"
    { (yyval) = createNode('+',0,(yyvsp[(1) - (3)]),(yyvsp[(2) - (3)])); }
    break;
