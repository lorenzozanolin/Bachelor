...
public class Test
{
    ...
    private static void SpostaPedina(PuzzleBoardC b,PuzzleBoard gui,int k)
    {
        int[] cOld= CercaCoordinate(b,k); //vettore che contiene le coordinate della pedina da spostare
         //cerca le coordinate del numero nella matrice associata, quindi le coordinate sono -1 rispetto a quelle della grafica (perche parte da 1, mentre quella non grafica parte da 0))
